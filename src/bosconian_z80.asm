...
040E: F5          push af
040F: 02          ld   (bc),a
0410: C3 03 5F    jp   $5F03
0413: 00          nop
0414: 3A 10 EF    ld   a,($EF10)
0417: 0E 15       ld   c,$15
0419: 03          inc  bc
041A: 71          ld   (hl),c
041B: 16 D7       ld   d,$D7
...
0807: 84          add  a,h
0808: 88          adc  a,b
0809: 01 00 00    ld   bc,$0000
080C: 00          nop
080D: E5          push hl
080E: 80          add  a,b
080F: C4 88 00    call nz,$0088
0812: 01 00 00    ld   bc,$0000
0815: AF          xor  a
...
0B16: 25          dec  h
0B17: 85          add  a,l
0B18: 11 62 19    ld   de,$1962
0B1B: 1E 1C       ld   e,$1C
0B1D: 11 24 1C    ld   de,$1C24
0B20: 1D          dec  e
0B21: 0A          ld   a,(bc)
0B22: 1B          dec  de
0B23: 1D          dec  e
...
0B2C: 85          add  a,l
0B2D: 0E 62       ld   c,$62
0B2F: 01 24 19    ld   bc,$1924
0B32: 15          dec  d
0B33: 0A          ld   a,(bc)
0B34: 22 0E 1B    ld   ($1B0E),hl
0B37: 24          inc  h
0B38: 18 17       jr   $0B51
0B3A: 15          dec  d
0B3B: 22 24 66    ld   ($6624),hl
0B3E: 85          add  a,l
0B3F: 0E 62       ld   c,$62
0B41: 01 24 18    ld   bc,$1824
0B44: 1B          dec  de
0B45: 24          inc  h
0B46: 02          ld   (bc),a
0B47: 24          inc  h
...
0B8F: 0E 0A       ld   c,$0A
0B91: 0D          dec  c
0B92: 22 19 15    ld   ($1519),hl
0B95: 0A          ld   a,(bc)
0B96: 22 0E 1B    ld   ($1B0E),hl
0B99: 24          inc  h
0B9A: 18 17       jr   $0BB3
0B9C: 0E 24       ld   c,$24
0B9E: 1D          dec  e
0B9F: 20 18       jr   nz,$0BB9
0BA1: 18 50       jr   $0BF3
0BA3: 1C          inc  e
0BA4: 60          ld   h,b
0BA5: 3C          inc  a
...
16DC: F0          ret  p
16DD: 16 02       ld   d,$02
16DF: F2 16 04    jp   p,$0416
16E2: F0          ret  p
16E3: 16 02       ld   d,$02
16E5: F4 16 04    call p,$0416
16E8: F4 16 04    call p,$0416
16EB: F2 16 06    jp   p,$0616
16EE: F0          ret  p
16EF: 16 20       ld   d,$20
16F1: 20 10       jr   nz,$1703
16F3: 10 50       djnz $1745
16F5: 50          ld   d,b
16F6: 20 20       jr   nz,$1718
16F8: C5          push bc
16F9: F5          push af
16FA: ED 44       neg
16FC: 5F          ld   e,a
...
1863: 00          nop
1864: 09          add  hl,bc
1865: 11 0B 02    ld   de,$020B
1868: 0A          ld   a,(bc)
1869: 10 08       djnz $1873
186B: 00          nop
186C: 05          dec  b
186D: 09          add  hl,bc
186E: 0D          dec  c
186F: 11 15 19    ld   de,$1915
1872: 17          rla
1873: 13          inc  de
1874: 0F          rrca
1875: 0B          dec  bc
...
1886: F1          pop  af
1887: 08          ex   af,af'
1888: F2 0B F5    jp   p,$F50B
188B: 0E F8       ld   c,$F8
188D: 0F          rrca
188E: FC 10 00    call m,$0010
1891: 0F          rrca
1892: 04          inc  b
1893: 0E 08       ld   c,$08
1895: 0B          dec  bc
...
189A: 0F          rrca
189B: 00          nop
189C: 10 FC       djnz $189A
189E: 0F          rrca
189F: F8          ret  m
18A0: 0E F5       ld   c,$F5
18A2: 0B          dec  bc
18A3: F2 08 F1    jp   p,$F108
18A6: 04          inc  b
18A7: F0          ret  p
18A8: 00          nop
18A9: F1          pop  af
18AA: FC F2 F8    call m,$F8F2
18AD: F5          push af
18AE: F5          push af
18AF: F8          ret  m
18B0: F2 FC F1    jp   p,$F1FC
...
19F7: 0E 49       ld   c,$49
19F9: 1D          dec  e
19FA: 11 0E 24    ld   de,$240E
19FD: 11 12 10    ld   de,$1012
1A00: 11 24 1C    ld   de,$1C24
1A03: 0C          inc  c
1A04: 18 1B       jr   $1A21
1A06: 0E 69       ld   c,$69
1A08: 85          add  a,l
...
1A0D: 24          inc  h
1A0E: 1D          dec  e
1A0F: 11 0E 24    ld   de,$240E
1A12: 0D          dec  c
1A13: 0A          ld   a,(bc)
1A14: 22 89 86    ld   ($8689),hl
1A17: 0A          ld   a,(bc)
1A18: 5F          ld   e,a
1A19: 10 18       djnz $1A33
1A1B: 24          inc  h
1A1C: 0F          rrca
1A1D: 18 1B       jr   $1A3A
1A1F: 24          inc  h
1A20: 1D          dec  e
1A21: 11 0E C6    ld   de,$C60E
1A24: 86          add  a,(hl)
1A25: 10 5F       djnz $1A86
1A27: 1C          inc  e
1A28: 19          add  hl,de
1A29: 0A          ld   a,(bc)
1A2A: 0C          inc  c
...
1CF8: C9          ret
1CF9: 5A          ld   e,d
1CFA: 20 5B       jr   nz,$1D57
1CFC: 20 5B       jr   nz,$1D59
1CFE: 20 20       jr   nz,$1D20
1D00: 1D          dec  e
1D01: CC 20 4D    call z,$4D20
1D04: 20 20       jr   nz,$1D26
1D06: 20 5A       jr   nz,$1D62
1D08: 4F          ld   c,a
1D09: 0D          dec  c
1D0A: 5D          ld   e,l
1D0B: 20 0D       jr   nz,$1D1A
1D0D: 5E          ld   e,(hl)
1D0E: 0D          dec  c
1D0F: 0D          dec  c
1D10: 20 CB       jr   nz,$1CDD
1D12: 7F          ld   a,a
...
2374: A1          and  c
2375: 88          adc  a,b
2376: C4 A2 88    call nz,$88A2
2379: C4 A2 88    call nz,$88A2
237C: C4 A2 88    call nz,$88A2
...
27C6: E0          ret  po
27C7: 27          daa
27C8: 10 00       djnz $27CA
27CA: 20 00       jr   nz,$27CC
27CC: 30 00       jr   nc,$27CE
27CE: 40          ld   b,b
27CF: 00          nop
27D0: 10 00       djnz $27D2
27D2: 00          nop
27D3: 10 00       djnz $27D5
27D5: F0          ret  p
27D6: F0          ret  p
27D7: 00          nop
27D8: 10 10       djnz $27EA
27DA: 10 F0       djnz $27CC
27DC: 20 20       jr   nz,$27FE
27DE: 20 E0       jr   nz,$27C0
27E0: 10 10       djnz $27F2
27E2: 10 F0       djnz $27D4
27E4: F0          ret  p
27E5: 10 F0       djnz $27D7
27E7: F0          ret  p
27E8: 40          ld   b,b
27E9: 03          inc  bc
27EA: 20 02       jr   nz,$27EE
27EC: 60          ld   h,b
27ED: 04          inc  b
27EE: 60          ld   h,b
27EF: 04          inc  b
...
27F6: FD          db   $fd
27F7: FD          db   $fd
27F8: FA FA FA    jp   m,$FAFA
27FB: FA FA FA    jp   m,$FAFA
27FE: FA FA FA    jp   m,$FAFA
2801: FA FA FA    jp   m,$FAFA
2804: FA FA FD    jp   m,$FDFA
2807: FD          db   $fd
2808: FF          rst  $38
2809: FF          rst  $38
280A: 00          nop
...
2833: 00          nop
2834: 00          nop
2835: 01 03 05    ld   bc,$0503
2838: 03          inc  bc
2839: 01 00 FF    ld   bc,$FF00
283C: FD          db   $fd
283D: FB          ei
283E: F9          ld   sp,hl
283F: F7          rst  $30
...
2876: FF          rst  $38
2877: 00          nop
2878: 01 01 01    ld   bc,$0101
287B: 01 01 01    ld   bc,$0101
287E: 01 01 01    ld   bc,$0101
2881: 01 01 01    ld   bc,$0101
2884: 01 01 01    ld   bc,$0101
2887: 01 00 00    ld   bc,$0000
288A: FF          rst  $38
288B: FF          rst  $38
288C: FF          rst  $38
288D: 00          nop
288E: 01 01 5A    ld   bc,$5A01
2891: 9C          sbc  a,h
2892: 64          ld   h,h
2893: A6          and  (hl)
2894: A6          and  (hl)
...
28C9: 00          nop
28CA: 9C          sbc  a,h
28CB: EC 00 9C    call pe,$9C00
28CE: EC 9C 0A    call pe,$0A9C
28D1: 9C          sbc  a,h
28D2: 14          inc  d
28D3: 9C          sbc  a,h
28D4: F6 9C       or   $9C
28D6: EC 9C 50    call pe,$509C
28D9: 9C          sbc  a,h
28DA: 5A          ld   e,d
28DB: 9C          sbc  a,h
28DC: 64          ld   h,h
...
29BC: 29          add  hl,hl
29BD: 0C          inc  c
29BE: 2A 1F 2A    ld   hl,($2A1F)
29C1: 32 2A 45    ld   ($452A),a
29C4: 2A 4C 2A    ld   hl,($2A4C)
29C7: 04          inc  b
29C8: 44          ld   b,h
29C9: 0E 0E       ld   c,$0E
29CB: 0E 0E       ld   c,$0E
...
2BC1: 5C          ld   e,h
2BC2: 29          add  hl,hl
2BC3: 2A 2B 2C    ld   hl,($2C2B)
2BC6: 2D          dec  l
2BC7: 2E 2F       ld   l,$2F
2BC9: 01 09 08    ld   bc,$0809
2BCC: 01 26 AF    ld   bc,$AF26
...
2E2C: 0E 26       ld   c,$26
2E2E: 1D          dec  e
2E2F: 22 19 0E    ld   ($0E19),hl
2E32: 31 87 06    ld   sp,$0687
2E35: 5E          ld   e,(hl)
2E36: 07          rlca
2E37: 00          nop
2E38: 24          inc  h
...
2E3A: 1D          dec  e
2E3B: 1C          inc  e
2E3C: E4 86 08    call po,$0886
2E3F: 5E          ld   e,(hl)
2E40: 1C          inc  e
2E41: 19          add  hl,de
2E42: 22 24 1C    ld   ($1C24),hl
2E45: 11 12 19    ld   de,$1912
2E48: 24          inc  h
2E49: 87          add  a,a
2E4A: 07          rlca
2E4B: 5E          ld   e,(hl)
...
2EA6: 70          ld   (hl),b
2EA7: 05          dec  b
2EA8: 20 00       jr   nz,$2EAA
2EAA: 70          ld   (hl),b
2EAB: FB          ei
2EAC: 20 05       jr   nz,$2EB3
2EAE: D0          ret  nc
2EAF: 00          nop
2EB0: 7A          ld   a,d
2EB1: FB          ei
...
32E2: E0          ret  po
32E3: 8E          adc  a,(hl)
32E4: 20 8F       jr   nz,$3275
32E6: 0C          inc  c
32E7: 09          add  hl,bc
32E8: 06 03       ld   b,$03
32EA: 00          nop
32EB: F5          push af
32EC: 32 F9 32    ld   ($32F9),a
32EF: FD          db   $fd
...
332F: ED B0       ldir
3331: C9          ret
3332: E4 8B E8    call po,$E88B
3335: 8B          adc  a,e
3336: EC 8B F0    call pe,$F08B
3339: 8B          adc  a,e
333A: 5C          ld   e,h
333B: 88          adc  a,b
...
343A: 86          add  a,(hl)
343B: D3 81       out  ($81),a
343D: EC 8B CB    call pe,$CB8B
3440: 8B          adc  a,e
3441: E4 86 D5    call po,$D586
3444: 81          add  a,c
3445: F0          ret  p
3446: 8B          adc  a,e
3447: CE 8B       adc  a,$8B
...
379B: 66          ld   h,(hl)
379C: 87          add  a,a
379D: 11 28 24    ld   de,$2428
37A0: 01 09 08    ld   bc,$0809
37A3: 01 24 17    ld   bc,$1724
37A6: 0A          ld   a,(bc)
37A7: 16 0C       ld   d,$0C
37A9: 18 24       jr   $37CF
37AB: 15          dec  d
...
3B70: CD 6D 3E    call $3E6D
3B73: 13          inc  de
3B74: 13          inc  de
3B75: 13          inc  de
3B76: CD 6D 3E    call $3E6D
3B79: D1          pop  de
3B7A: E1          pop  hl
3B7B: E5          push hl
...
3BAD: D5          push de
3BAE: CD 6D 3E    call $3E6D
3BB1: 13          inc  de
3BB2: 13          inc  de
3BB3: 13          inc  de
3BB4: CD 6D 3E    call $3E6D
3BB7: E1          pop  hl
...
3BF1: 17          rla
3BF2: 18 1D       jr   $3C11
3BF4: 11 12 17    ld   de,$1712
3BF7: 10 24       djnz $3C1D
3BF9: 24          inc  h
3BFA: 24          inc  h
3BFB: 24          inc  h
3BFC: 24          inc  h
...
3D70: 66          ld   h,(hl)
3D71: 87          add  a,a
3D72: 11 28 24    ld   de,$2428
3D75: 01 09 08    ld   bc,$0809
3D78: 01 24 17    ld   bc,$1724
3D7B: 0A          ld   a,(bc)
3D7C: 16 0C       ld   d,$0C
3D7E: 18 24       jr   $3DA4
3D80: 15          dec  d
...
3D82: 0D          dec  c
3D83: 34          inc  (hl)
3D84: 01 04 02    ld   bc,$0204
3D87: 06 04       ld   b,$04
3D89: 01 08 04    ld   bc,$0408
3D8C: 00          nop
